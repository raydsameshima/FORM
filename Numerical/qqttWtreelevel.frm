...
*
* Adapt this old code to the calculation of  t tbar W at tree level
*
********************************************************************************
*
* Zuerich, May 25, 2007
...
s c'l';
#enddo
s di,df,dI,dF,gs,ge,del,M,MW,s,t,[u],a,dk,dk1,dk2,dl,dl1,dl2,dm,dn,N,[N^2-1];
s Nc,[Nc^2-1],sqrt2;
i X,Y;
i aX, aY, al, be,ro;
...
[u-M^2],[d-4],[N^2-1];
s p1dp2,p1dp3,p1dp4,p2dp3,p2dp4,p3dp4,aem,sw,Pi;
.global
********************************************************************************
...
R(g_(1,p1)-g_(1,p5),d94,d95)*i_*ge/sqrt2/2*R(g_(1,mu3)*(gi_(1)+g5_(1)),d95,d99)*
...
C(ll(a2),i98,i96)
*
-R(vb(1,p2),d97)*i_*ge/sqrt2/2*R(g_(1,mu3)*(gi_(1)+g5_(1)),d97,d94)*(i_)*
...
id hCOMPLEXCONJ =
-R(ub(1,p1),dk)*i_*ge/sqrt2/2*R(g_(1,mu4)*(gi_(1)+hA*g5_(1)),dk,dk1)*
(-i_)*R(g_(1,p1)-g_(1,p5),dk1,dk2)*prop(p1-p5)*i_*gs/2*R(g_(1,al),dk2,dl)*C(ll(a21),ik,il)*
R(v(1,p2),dl)*(dd(a21,a22)*d_(al,be)*prop(p1+p2-p5))*R(vb(2,p3),dm)*i_*gs/2*
R(g_(2,be),dm,dn)*C(ll(a22),im,in)*R(u(2,p4),dn)
*
-R(ub(1,p1),dk)*i_*gs/2*R(g_(1,al),dk,dl1)*C(ll(a21),ik,il)*
(i_)*R(g_(1,p2)-g_(1,p5),dl1,dl2)*prop(p2-p5)*i_*ge/sqrt2/2*R(g_(1,mu4)*(gi_(1)
+hA*g5_(1)),dl2,dl) *R(v(1,p2),dl)*
...
id p1.p2 = 1/2*(2*a-MW^2-2*p3.p4+2*p1.p3+2*p2.p3+2*p1.p4+2*p2.p4);
...
id N = Nc;
id [N^2-1] = [Nc^2-1];
* AT THIS STAGE I SHOULD BE ABLE TO COMPARE WITH DANIEL
b MW,prop,propM,Nc,[Nc^2-1],aem,Pi,sw;
*ab hM1,hM2,hM3;
* print[];
#message~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#message tree level matrix element squared for q qbar -> t tbar W 
...
* all terms are prop^4 and sign blind!
Vector q;
id prop(q?) = prop(q.q);
