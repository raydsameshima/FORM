...
R(g_(1,p1)-g_(1,p5),d94,d95)*i_*ge/2/cw*R(g_(1,mu3)*(
-2*sw^2*Qq*gi_(1) + I3q*(gi_(1)+g5_(1))),d95,d99)*
...
id hCOMPLEXCONJ =
-R(ub(1,p1),dk)*i_*ge/2/cw*R(g_(1,mu4)*(
-2*sw^2*Qq*gi_(1) + I3q*(gi_(1)+g5_(1))),dk,dk1)*
