...
* Gluons are vector(i's) boson, and they carry colour charge(d's).
* It needs to use eq.(D.41) for tripel gluon interaction.
Local Amp = 
            e(j1,p1,mg,c1,d1)*e(j2,p2,mg,c2,d1)* 
            structure(d1,d2,d3)*
            e(j3,p1+p2,mg,c3,d3)*
...
id structure(d1?,d2?,d3?) 
  = -2*i_* 
  ( T(c5,c6,d1)*T(c6,c7,d2)*T(c7,c5,d3) 
  - T(c5,c6,d2)*T(c6,c7,d1)*T(c7,c5,d3)
  );
