...
* If you want to use v(i) of i-th vector v, the indeces i must be declared.
* The default dimension of the underlying v.s. is 4, but it can be changed by the Dimension Statement.
